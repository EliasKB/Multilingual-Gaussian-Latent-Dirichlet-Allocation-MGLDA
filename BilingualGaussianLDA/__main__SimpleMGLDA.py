...
rate_usageOfData_source_Amazon = 0.02
rate_usageOfData_target_Amazon = 0.2
rate_usageOfData_source_Novel = 1.0
rate_usageOfData_target_Novel = 1.0
learning_rate = 0.05
n_topic = 20
n_gibbs_iteration_source = 2
n_gibbs_iteration_target = 2
...
if __name__ == "__main__":
    ...
    print(" The time taken for preproessing of corpus and loading the model for target language is", (time_source2-time_source1)/60)
    ...
    """ Step 4. Training the model on the target language with joint embedding """
    ...
    model_target.fit(iterations = n_gibbs_iteration_target)
